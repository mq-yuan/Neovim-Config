...
_G.packer_plugins = {
  ...
  ["nvim-surround"] = {
    loaded = true,
    path = "/home/neovim/.local/share/nvim/site/pack/packer/start/nvim-surround",
  ...
  ["nvim-treesitter-context"] = {
    loaded = true,
    path = "/home/neovim/.local/share/nvim/site/pack/packer/start/nvim-treesitter-context",
